...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    NSString *date = [dateformate stringFromDate:enteredBackground]; // Convert date to string
    NSLog(@"date :%@",date);
}
...
- (void)applicationWillEnterForeground:(UIApplication *)application {
    ...
    {
        NSTimeInterval timeInterval = [enteredBackground timeIntervalSinceNow];
        ...
        NSLog(@"since inactive: %f", timeInterval);
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "dc.org.HBXMobile" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HBXMobile" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"HBXMobile.sqlite"];
    NSError *error = nil;
